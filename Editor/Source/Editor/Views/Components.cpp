...
template<> bool SceneNodeView::ShowComponent(Components::DirLight& dirLight)
{
...
template<> bool SceneNodeView::ShowComponent(Components::PointLight& pointLight)
{
	ChangeObserver observer;
...
template<> bool SceneNodeView::ShowComponent(Components::Transform& tr)
{
	ChangeObserver observer;
...
template<> bool SceneNodeView::ShowComponent(Components::Camera& cam)
{
	ChangeObserver observer;
...
template<> bool SceneNodeView::ShowComponent(Components::Drawable& dr)
{
	ChangeObserver observer;
...
template<> bool SceneNodeView::ShowComponent(Components::Physics& phx)
{
	ChangeObserver observer;
...
template<> bool SceneNodeView::ShowComponent(Components::Tag& tag)
{
