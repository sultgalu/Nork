...
namespace Nork::Renderer
{
	...
	void LoadUtils::WriteImage(const Image& image, const std::string& path)
	{
		int res = stbi_write_bmp(path.c_str(), image.width, image.height, image.channels, image.data.data());
		if (res == 0)
		{
