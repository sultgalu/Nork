...
//		return cube;
//	}
//	Mesh::Mesh(size_t initialVboSize, size_t initialIboSize)
//	{
...
//	}
//	SubMesh& Mesh::AddSubMesh(const std::vector<Vertex>& vertices, const std::vector<unsigned int>& indices)
//	{
//		if (!vao->HasIbo())
//		{
//			std::abort();
...
//		auto vbo = vao->GetVBO();
//		auto ibo = vao->GetIBO();
//		subMesh.vertOffs = vbo->GetCount<Vertex>();
//		subMesh.indexOffs = vbo->GetCount<uint32_t>();
//		subMesh.vertCount = vertices.size();
