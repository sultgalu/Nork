...
private:
    ...
    void createTextureSampler()
    {
        ...
        vkCreateSampler(device, &samplerInfo, nullptr, &textureSampler) == VkSuccess();
    }
    ...
    void createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
    {
        ...
        vkCreateImage(device, &imageInfo, nullptr, &image) == VkSuccess();
        ...
        vkAllocateMemory(device, &allocInfo, nullptr, &imageMemory) == VkSuccess();
    ...
    void createDescriptorSets()
    {
        ...
        vkAllocateDescriptorSets(device, &allocInfo, descriptorSets.data()) == VkSuccess();
    ...
    void createDescriptorPool()
    {
        ...
        vkCreateDescriptorPool(device, &poolInfo, nullptr, &descriptorPool) == VkSuccess();
    }
    ...
    void createDescriptorSetLayout()
    {
        ...
        vkCreateDescriptorSetLayout(device, &layoutInfo, nullptr, &descriptorSetLayout) == VkSuccess();
    }
    ...
    void createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
    {
        ...
        vkCreateBuffer(device, &bufferInfo, nullptr, &buffer) == VkSuccess();
        ...
        vkAllocateMemory(device, &allocInfo, nullptr, &bufferMemory) == VkSuccess();
    ...
    void createSyncObjects()
    {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
        {
            vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphores[i]) == VkSuccess();
            vkCreateSemaphore(device, &semaphoreInfo, nullptr, &renderFinishedSemaphores[i]) == VkSuccess();
            vkCreateFence(device, &fenceInfo, nullptr, &inFlightFences[i]) == VkSuccess();
        }
    }
    ...
    void createCommandBuffer()
    {
        ...
        vkAllocateCommandBuffers(device, &allocInfo, commandBuffers.data()) == VkSuccess();
    }
    void createCommandPool()
    {
        ...
        vkCreateCommandPool(device, &poolInfo, nullptr, &commandPool) == VkSuccess();
    ...
    void createFramebuffers()
    {
        ...
        for (size_t i = 0; i < swapChainImageViews.size(); i++)
        {
            ...
            vkCreateFramebuffer(device, &framebufferInfo, nullptr, &swapChainFramebuffers[i]) == VkSuccess();
        }
    }
    void createRenderPass()
    {
        ...
        vkCreateRenderPass(device, &renderPassInfo, nullptr, &renderPass) == VkSuccess();
    }
    ...
    void createGraphicsPipeline()
    {
        ...
        vkCreatePipelineLayout(device, &pipelineLayoutInfo, nullptr, &pipelineLayout) == VkSuccess();
        ...
        vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) == VkSuccess();
    ...
    void createSwapChain()
    {
        ...
        vkCreateSwapchainKHR(device, &createInfo, nullptr, &swapChain) == VkSuccess();
    ...
    void createSurface()
    {
        glfwCreateWindowSurface(instance, window, nullptr, &surface) == VkSuccess();
    }
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        memcpy(uniformBuffersMapped[currentImage], &vp, sizeof(vp));
    }
    void mainLoop()
    {
    ...
    void drawFrame()
    {
        ...
        vkQueueSubmit(graphicsQueue, 1, &submitInfo, inFlightFences[currentFrame]) == VkSuccess();
        ...
        presentInfo.pResults = nullptr; // Optionalresult = vkQueuePresentKHR(presentQueue, &presentInfo);
