...
uniform vec3 v3LightPos = vec3(10.0f, 100.0f, 10.0f);
in vec3 v3Pos;
uniform vec3 v3InvWavelength = vec3(2.0f);
float fCameraHeight = 1.0f;
float fCameraHeight2 = 1.0f;
uniform float fInnerRadius = 1.0f;
float fInnerRadius2 = 1.0f;
uniform float fOuterRadius = 10.0f;
float fOuterRadius2 = 100.0f;
uniform float kr = 1.0f;
uniform float km = 1.0f;
uniform float ESun = 1.0f;
float fKrESun = 1.0f;
float fKmESun = 1.0f;
float fKr4PI = 1.0f;
float fKm4PI = 1.0f;
float fScale = 1.0f;
float fScaleOverScaleDepth = 1.0f;
uniform float fScaleDepth = 0.25f;
...
void main ()
{
    ...
    fCameraHeight2 = pow(fCameraHeight, 2.0f);
    fInnerRadius2 = pow(fInnerRadius, 2.0f);
    fOuterRadius2 = pow(fOuterRadius, 2.0f);
    ...
    fScale = fOuterRadius - fInnerRadius;
